...
int main() {
    ...
    //First choice: I can make document with only one KV pair.  So insert operations execute insert operations. 
    ...
    {
        auto insert_one_result = collection.insert_one(make_document(kvp("i", 0))); //This is key code for insert operations.
